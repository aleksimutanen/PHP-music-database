...
$role = $artist = $name = $image = "";
$role_err = $artist_err = $name_err = $image_err = "";

$param_role = $param_artist = $param_name = $param_image = "";

##################################

$stmt = mysqli_prepare($link, "INSERT INTO member (roleid, artistid, name, image) VALUES (?, ?, ?, ?)");
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($name_err) && empty($role_err) && empty($artist_err) && empty($image_err)) {
