...
$genre = $logo = $name = $image = $info = $country = "";
$genre_err = $logo_err = $name_err = $image_err = $info_err = $country_err = "";

$param_genre = $param_logo = $param_name = $param_image = $param_info = $param_country = "";

##################################

$stmt = mysqli_prepare($link, "INSERT INTO artist (genreid, logo, name, image, info, country) VALUES (?, ?, ?, ?, ?, ?)");
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($name_err) && empty($genre_err) && empty($logo_err) && empty($image_err) && empty($info_err) && empty($country_err)) {
